...
Future<WeatherData> getCountryData(String country) async {
 final today = HttpService(baseUrl:'https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=$authkey&limit=7&format=JSON&locationName=$country&elementName=&sort=time' );
...
final dddddd = 'https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-D0047-091?Authorization=CWB-95C4A955-4E38-4B86-92B4-2F1E71669956&format=JSON&locationName=%E6%96%B0%E7%AB%B9%E7%B8%A3&elementName=MaxAT,Wx';

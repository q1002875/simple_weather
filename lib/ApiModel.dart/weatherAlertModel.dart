...
class Record {
  ...
  Record({this.datasetInfo, this.contents, this.hazardConditions});
...
class Hazards {
  ...
  factory Hazards.fromJson(Map<String, dynamic> json) {
    var hazardList = json['hazard'] as List;
    List<Hazard> hazards =
...
class Info {
  ...
  Info({this.language, this.phenomena, this.significance, this.affectedAreas});
